...
struct lsi_config_s
{
     ...
     */
    void                           *(*_parse_config)(const char *param,
...
struct lsi_api_s
{
     ...
     */
    int (*add_session_hook)(lsi_session_t *pSession, int index,
                            const lsi_module_t *pModule, lsi_callback_pf cb, short priority,
                            short flag);
     ...
     * @param[in] pModule - a pointer to the lsi_module_t struct.
     */
    int (*remove_session_hook)(lsi_session_t *pSession, int index,
                               const lsi_module_t *pModule);
    ...
    */
     ...
     *
     */
    int (*set_timer)(unsigned int timeout_ms, lsi_timer_callback_pf timer_cb,
                     void *timer_cb_param);
     ...
     */
    int (*get_resp_headers)(lsi_session_t *pSession, struct iovec *iov,
                            int maxIovCount);
