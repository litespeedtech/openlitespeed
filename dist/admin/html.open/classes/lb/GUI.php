...
<html>
<head>
	<title>LiteSpeed Web Admin Console: {$title}</title>
...
<tr >
<td style='border-bottom:1px solid #cacaca;padding-bottom:2px;'><a href='/index.php'><img src='/static/images/logo/loadbalancer.gif' border=0></a></td>
...
<div id='nav' class='xui_menu'>
  <ul>
	...
	<li><a href='/config/confMgr.php?m=lbtop'>Clusters</a></li>
...
<div id=copyright align=center>Copyright &copy; 2002-2013. <a href='http://www.litespeedtech.com'>Lite Speed Technologies, Inc.</a></div>
	...
	public static function left_menu() {
		...
		$stuff = array("Server" => "serv",
			"Listeners (" . count($listeners) . ")" => "sl",
			"Clusters (" . count($clusters) . ")" => "lb",
			"Virtual Hosts (" . count($vhosts) . ")" => "vh", 
			"Virtual Host Templates (" . count($templates) . ")" => "tp",);
