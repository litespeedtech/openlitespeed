...
class DAttr
{
	...
	public $_version; // 0: no restriction; 1: LSWS ENTERPRISE; 2: LSWS 2CPU +; 3: LSLB 2CPU +
	public $_note;
	public $_icon;
...
// public:
	...
	{
		$d = new DAttr($this->_key, $this->_type, $this->_label, $this->_inputType, $this->_allowNull,
	...
	private function extractCheckBoxOr()
	{
		$value = 0;
		$novalue = 1;
	...
	private function extractSplitMultiple(&$value)
	{
		if ( $this->_glue == ' ' )
	...
	private function toHtmlContent($cval, $refUrl=NULL)
	{
		$o = '';
	...
	private function check_split($value, $width)
	{
		if ( $value == NULL )
			return NULL;
...
//private:
	private function genOptions($options, $selValue)
	{
		$o = '';
		if ( $options )
		{
