...
class DTblDef
{
	...
	protected function add_APACHE_CONF_FILE( $id )
	{
	...
	protected function add_SERV_APACHECONF($id)
	{
	...
	protected function add_SERV_SEC_CC($id)
	{
	...
	protected function add_VH_SEC_CC($id)
	{
		$this->_tblDef[$id] = new DTbl($id, 'Request Filter');
	...
	protected function add_SERV_CACHE_STORAGE($id)
	{
	    $this->_tblDef[$id] = new DTbl($id, 'Cache Storage Settings');
	    $cacheStorePath = new DAttr('cacheStorePath', 'path', 'Storage Path', 'text', false, 3, 'rwc', $this->_options['text_size']);
	    $cacheStorePath->_version = 2;
	    $maxCacheObjSize = new DAttr('maxCacheObjSize', 'uint', 'Max Object Size', 'text', true, 1024, 1024000);
	    $maxCacheObjSize->_version = 2;
	    $attrs = array(
			$cacheStorePath, 
			$maxCacheObjSize,  
		);
	...
	protected function add_A_CACHE_POLICY($id)
	{
	...
	protected function add_SERV_CACHE_NCURL($id)
	{
	...
	protected function add_SERV_CACHE_NCDOMAIN($id)
	{
	...
	protected function add_VH_APACHECONF($id)
	{
	...
	protected function add_VH_FRONTPG($id)
	{
	...
	protected function add_VH_AWSTATS($id)
	{
...
// to do: need check path contain VH variable.
	...
	protected function add_TP_AWSTATS($id)
	{
