...
$_tipsdb['sslProtocol'] = new DAttrHelp("Protocol Version", 'A selection of SSL protocols accepted by the listener.<br/><br/>Options include: SSL v3.0, TLS v1.0, TLS v1.1, TLS v1.2, TLS v1.3.', '', '从复选框中选择', '');
