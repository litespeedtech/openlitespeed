...
$_tipsdb['accessLog_logFormat'] = new DAttrHelp("日志格式", ' 指定访问日志的格式。 设置之后，它将覆盖&quot;记录头部&quot; 的设定。', '', '字符串。日志格式的语法与Apache 2.0自定义 <a href="http://httpd.apache.org/docs/2.0/mod/mod_log_config.html#formats " target="_blank" rel="noopener noreferrer">日志格式</a>兼容。', '一般日志格式（CLF）<br/>	&quot;%h %l %u %t \&quot;%r\&quot; %>s %b&quot;<br/><br/>支持虚拟主机的一般日志格式<br/>	&quot;%v %h %l %u %t \&quot;%r\&quot; %>s %b&quot;<br/><br/>NCSA扩展/组合日志格式<br/>	&quot;%h %l %u %t \&quot;%r\&quot; %>s %b \&quot;%{Referer}i\&quot; \&quot;%{User-agent}i\&quot; <br/><br/>记录Foobar的cookie值<br/>   &quot;%{Foobar}C&quot;');
