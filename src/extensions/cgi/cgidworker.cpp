...
int CgidWorker::config(const XmlNode *pNode1)
{
    ...
    int priority = ConfigCtx::getCurConfigCtx()->getLongValue(pNode1,
                   "priority", -20, 20, HttpGlobals::s_priority + 1);
    ...
    HttpGlobals::s_uidMin = ConfigCtx::getCurConfigCtx()->getLongValue(pNode1,
                            "minUID", 10, INT_MAX, 10);
    HttpGlobals::s_gidMin = ConfigCtx::getCurConfigCtx()->getLongValue(pNode1,
                            "minGID", 5, INT_MAX, 5);
