...
public:
    ...
    static int checkMultiLineMode(const char * sLine, char *sMultiLineModeSign, int maxSize);
    static bool isInclude(const char * sLine, AutoStr2 &path);
    
    static void saveUnknownItems(const char *fileName, int lineNumber, XmlNode *pCurNode, const char *name, const char *value);
    static void appendModuleParam(XmlNode *pModuleNode,const char *param);
    static void addModuleWithParam(XmlNode *pCurNode, const char *moduleName, const char *param);
    ...
    static void parseLine(const char *fileName, int lineNumber, const char *sLine);
    
    static int checkFiletype(const char *path);
    static void getIncludeFile(const char *orgFile, char *targetFile);
    
    static const char *getConfDeepValue(const XmlNode *pNode, const char *name);
