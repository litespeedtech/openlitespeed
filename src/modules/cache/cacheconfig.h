...
public:
    ...
    void setDefaultAge(int age)
    {
        m_defaultAge = age;
    }
    int  getDefaultAge() const
    {
        return m_defaultAge;
    }

    void setPrivateAge(int age)
    {
        m_privateAge = age;
    }
    int  getPrivateAge() const
    {
        return m_privateAge;
    }
    ...
    int  isPrivateEnabled() const
    {
        return m_iCacheFlag & CACHE_PRIVATE_ENABLED;
    }
    ...
    int  isEnabled() const
    {
        return m_iCacheFlag & CACHE_ENABLED;
    }
    int  isSet(int bit) const
    {
        return m_iCacheFlag & bit;
    }
    int  getConfigBits(int bit) const
    {
        return m_iCacheConfigBits & bit;
    }
