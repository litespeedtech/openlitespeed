...
TEST( httprange_test )
{
    ...
    lsr_xpool_init( &pool );
    range = new( lsr_xpool_alloc( &pool, sizeof( HttpRange ))) HttpRange( el );
    ...
    HttpRange *range1;
    range1 = new( lsr_xpool_alloc( &pool, sizeof( HttpRange ))) HttpRange( el );
    ...
    HttpRange *range2;
    range2 = new( lsr_xpool_alloc( &pool, sizeof( HttpRange ))) HttpRange( 1447936 );
    const char * pdfRange =
