...
//     char Result.begin()[2000];
    ...
    Result.clear();
    int n = TestInflator.spdyHeaderInflate((char*)c2s_SYN_STREAM1+18, sizeof(c2s_SYN_STREAM1)-18, Result);
    CHECK( n > 0 );
    printbuff( (unsigned char*)Result.begin(), n);
    printheader( (unsigned char*)Result.begin(), n);
    int n1 = TestDeflator.spdyHeaderDeflate(Result.begin(), 50, &Result1, 0);
    CHECK( n1 >= 0 );
    ntotal += n1;
    printf("finished Compressing 0-50 n1=%d, total=%d\n", n1, ntotal);
    n1 = TestDeflator.spdyHeaderDeflate(Result.begin() + 50, 200, &Result1, 0);
    CHECK( n1 >= 0 );
    ntotal += n1;
    printf("finished Compressing 50-250 n1=%d, total=%d\n", n1, ntotal);
    n1 = TestDeflator.spdyHeaderDeflate(Result.begin() + 250, n-250, &Result1, Z_SYNC_FLUSH);
    CHECK( n1 >= 0 );
    ntotal += n1;   
    ...
    n = TestInflator1.spdyHeaderInflate(pResult1, ntotal,  Result);
    CHECK( n > 0 );
    printbuff( (unsigned char*)Result.begin(), n);
    printheader( (unsigned char*)Result.begin(), n);   
    Result.clear();
    n = TestInflator.spdyHeaderInflate((char*)c2s_SYN_STREAM2+18, sizeof(c2s_SYN_STREAM2)-18, Result);
    CHECK( n > 0 );
    printbuff( (unsigned char*)Result.begin(), n);
    printheader( (unsigned char*)Result.begin(), n);   
    Result1.clear();
    n1 = TestDeflator.spdyHeaderDeflate(Result.begin(), n, &Result1, Z_SYNC_FLUSH);
    CHECK( n1 > 0 );
    printf("UncompressLen=%d, CompressedLen=%d\n", n, n1);
    Result.clear();
    pResult1 = Result1.getPointer(0);
    n = TestInflator1.spdyHeaderInflate(pResult1, n1,  Result);
    CHECK( n > 0 );
    printbuff( (unsigned char*)Result.begin(), n);
    printheader( (unsigned char*)Result.begin(), n); 
}
