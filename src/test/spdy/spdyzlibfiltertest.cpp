...
//     char Result.begin()[2000];
    ...
    Result.clear();
    int n = TestInflator.decompress((char*)c2s_SYN_STREAM1+18, sizeof(c2s_SYN_STREAM1)-18, Result);
    CHECK( n > 0 );
    ...
    n1 = TestDeflator.compress(Result.begin() + 250, n-250, &Result1, Z_SYNC_FLUSH);
    CHECK( n1 >= 0 );
    ntotal += n1;   
    ...
    printheader( (unsigned char*)Result.begin(), n);   
    Result.clear();
    n = TestInflator.decompress((char*)c2s_SYN_STREAM2+18, sizeof(c2s_SYN_STREAM2)-18, Result);
    CHECK( n > 0 );
    printbuff( (unsigned char*)Result.begin(), n);
    printheader( (unsigned char*)Result.begin(), n);   
    Result1.clear();
