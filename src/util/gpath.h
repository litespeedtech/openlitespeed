...
class GPath
{
    ...
    ~GPath(){};
public:
    static int getAbsolutePath(char* dest, size_t size, const char* relativeRoot, const char* path);
    static int getAbsoluteFile(char* dest, size_t size, const char* relativeRoot, const char* file);
    static int concat(char* dest, size_t size, const char* pRoot, const char* pAppend);
    ...
    static int  readFile( char * pBuf, int bufLen, const char *pName, const char *pBase = NULL );
